...
SECTIONS = [
 ...
 dict(name='CRATER', root=45, sc=NAT, energy=0.48, shape='deep', bars=104, bass='round',
      chords=[[45,52,60,63,67],[40,47,55,60]],
      motif=[(0,2,1,6),(8,0,1,4),(16,3,1,6),(24,2,1,6)]),
 dict(name='ERUPCION', root=45, sc=NAT, energy=0.97, shape='peak', bars=160, bass='roll',
 ...
 dict(name='RIO', root=43, sc=NAT, energy=0.78, shape='wave', bars=128, bass='roll',
      chords=[[43,50,58,62],[40,47,55,59],[38,45,53,57],[40,47,55,59]],
      motif=[(0,4,1,3),(6,5,1,2),(10,4,1,2),(16,2,1,3),(22,4,1,2),(26,5,1,5)]),
 dict(name='VIDRIO', root=40, sc=NAT, energy=0.52, shape='outro', bars=88, bass='round',
