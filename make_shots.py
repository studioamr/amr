...
TAMB_MARK = '<path d="M78 64 L162 64 L149 110 C144 126 154 136 157 152 L83 152 C86 136 96 126 91 110 Z" fill="#141210"/><ellipse cx="120" cy="64" rx="42" ry="12" fill="#C9A227"/><path d="M84 80 L156 106 M156 80 L84 106 M84 106 L156 132 M156 106 L84 132" stroke="#E8C96A" stroke-width="3" opacity="0.7"/><rect x="64" y="152" width="112" height="7" rx="3" fill="#141210"/>'
...
SHOTS = [
    dict(id='tambor',    accent='#C9A227', accent_lt='#E8C96A', title='TAMBOR',    sub='AFRO MELODIC · 0→100 · 29 MIN', edition=15, num='01', mark=TAMB_MARK, tsize=56),
